...
class HtmlFormatter
{
    ...
    public function Format(Document $document)
    {
        ...
        $this->openedTags = ['span' => false, 'p' => false, 'a' => false];
    ...
    protected function ProcessDestination($dest): void
    {
    ...
    protected function FormatEntry($entry): void
    {
    ...
    protected function FormatControlWord($word)
    {
        switch ($word->word) {
            ...
            case 'tab':
                $this->Write("&nbsp;");
                break;  // Character value 9
            case 'line':
                $this->output .= "<br/>";
                break; // character value (line feed = &#10;) (carriage return = &#13;)
